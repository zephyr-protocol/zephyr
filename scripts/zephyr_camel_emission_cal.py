...
DIFFICULTY_TARGET = 90 # seconds
MONEY_SUPPLY         = 45000000000000000
GENESIS_BLOCK_REWARD     = 10000000000
FINAL_SUBSIDY = 10000000000
COIN_EMISSION_MONTH_INTERVAL = 3 #months
...
if __name__ == "__main__":
    f = open("zephyr_camel_emmission.txt", "w")
